...
console.log('=====================================================');
console.log('');
const alice = crypto_1.default.getDiffieHellman('modp15');
const bob = crypto_1.default.getDiffieHellman('modp15');
...
//============================================================================================================
const Hasher_1 = require("./algorithms/Hasher");
console.clear();
...
console.log('Hashed with SHA-1:\t', Hasher_1.Hasher.textToSha1(stringToHash));
console.log('Hashed with MD5:\t', Hasher_1.Hasher.textToMd5(stringToHash));
