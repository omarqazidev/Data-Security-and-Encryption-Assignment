...
const PrimeNumber_1 = require("./algorithms/PrimeNumber");
const EulerToient_1 = require("./algorithms/EulerToient");
class RSA {
    ...
    computePublicKey() {
        this.productOfPrime = (this.primeNum1 - 1) * (this.primeNum2 - 1); //eulersToientAndMultiply(this.primeNum1, this.primeNum2);
        this.publicKey = EulerToient_1.getCoPrime(this.productOfPrime)[0];
    }
    getPublicKey() {
    ...
    decrypt(cipherText) {
        ...
        let plainText;
        //plainText = xgcd(cipherText, this.productOfPrime);
        plainText = big_integer_1.default(cipherText)
            .pow(this.privateKey)
            .mod(this.primeNum1 * this.primeNum2);
        // console.log(paintText.toString());
